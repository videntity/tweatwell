...
class Spin(models.Model):
    ...
    def __unicode__(self):
        return '%s spin cost %s points on %s' % (self.user, self.points, self.evdt)
    def save(self, **kwargs):
        super(Spin, self).save(**kwargs)  
...
class Roulette(models.Model):
    ...
    def __unicode__(self):
        return '%s got %s points on %s' % (self.user, self.points, self.evdt)
    def save(self, **kwargs):
        super(Roulette, self).save(**kwargs)  